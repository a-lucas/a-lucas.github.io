(function () {
    ...
    'use strict';
    angular.module('unsafeHtml', []).filter('unsafe', ['$sce', function ($sce) {
        return function (val) {
...
(function () {
    ...
    var myModule = angular.module('Antoine_Lucas_CV.services', []).service('DataSource', ['$http', function ($http) {
...
// Declare app level module which depends on views, and components
    angular.module('Antoine_Lucas_CV').controller("AppCtrl", ['$scope', '$rootScope', '$mdMedia', '$timeout', '$document', '$window', '$mdSidenav', '$parse', '$log', function ($scope, $rootScope, $mdMedia, $timeout, $document, $window, $mdSidenav, $parse, $log) {
    ...
    angular.module('Antoine_Lucas_CV.portfolio', ['Antoine_Lucas_CV.services'])
            .controller('PortfolioCtrl', ['$scope', 'DataSource', function ($scope, DataSource) {
    ...
    angular.module('Antoine_Lucas_CV.service', ['Antoine_Lucas_CV.services'])
            .controller('ServiceCtrl', ['$scope', '$timeout', 'DataSource', function ($scope, $timeout, DataSource) {
    ...
    angular.module('Antoine_Lucas_CV.skills', ['Antoine_Lucas_CV.services'])
            .controller('SkillsCtrl', ['$scope', 'DataSource', function ($scope, DataSource) {
...
;(function () {
    ...
    angular.module('Antoine_Lucas_CV.technologies', ['Antoine_Lucas_CV.services'])
            .controller('TechnologiesCtrl', ['$scope', 'DataSource', function ($scope, DataSource) {
