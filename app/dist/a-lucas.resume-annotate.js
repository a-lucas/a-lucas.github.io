...
// Declare app level module which depends on views, and components
    angular.module('Antoine_Lucas_CV')
        ...
        .controller("AppCtrl", ['$scope', '$rootScope', '$mdMedia', '$timeout', '$document', '$window', '$mdSidenav', '$parse', '$log', function ($scope, $rootScope, $mdMedia, $timeout, $document, $window, $mdSidenav, $parse, $log) {
    ...
    angular.module('Antoine_Lucas_CV.open', ['Antoine_Lucas_CV.services'])
            .controller('OpenCtrl', ['$scope', 'DataSource', function ($scope, DataSource) {
    ...
    angular.module('Antoine_Lucas_CV.intro', ['Antoine_Lucas_CV.services'])
        .controller('IntroCtrl', ['$scope', 'DataSource', function ($scope, DataSource) {
